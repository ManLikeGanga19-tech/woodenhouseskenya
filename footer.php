        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Naivasha, Kenya</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <?php echo date("Y"); ?> <a class="border-bottom" href="#">Wooden Houses Kenya</a>, All Right Reserved.
                    </div>
                </div>
            </div>
        </div>
